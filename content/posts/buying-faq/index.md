...
Sample scenario, you are A, all other letters are other bidders. An item is listed at 1,000 JPY, you have a sniper bid set for 10,000 JPY. B currently has the winning bid (and has a max bid of 5,000 JPY).
...
Time is the main factor here. A suggestion is to have searches for whichever plushes or items you want, bookmark all of them and store them in a bookmark folder, and then you should be able to right-click "open all bookmarks" for that folder to quickly scan all your relevant pages & queries. And then you need consistency to do this often enough to spot a good deal, and a bit of luck. Another tip is to sort the pages by "most recently updated" before bookmarking so you'll always see the latest items at the top and have less searching to do. If you need help navigating the Japanese UI, just ask for help in the server in one of the channels.
